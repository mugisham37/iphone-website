...
const Model = () => {
  ...
  const [model, setModel] = useState<ModelColor>({
  ...
  // Camera control for the model view - using any due to complex @react-three/drei OrbitControls typing
  ...
  }, [size, tl, smallRotation, largeRotation]);
            ...
            <div className="flex-center">
              <ul className="color-container">
                {models.map((item, i) => (
                  <li 
                    key={i} 
                    className="w-6 h-6 rounded-full mx-2 cursor-pointer hover:scale-110 transition-transform duration-200" 
